  ...
  const server = http.createServer((req, res) => {
    try {
      ...
      if (url.pathname === "/callback" && url.searchParams.has("code")) {
        ...
        res.end(`<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>PyxCloud · Authorized</title><style>*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,Ubuntu,Cantarell,sans-serif;background:#f8fafc;color:#1e293b;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:2rem}.card{background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,.08);padding:3rem 2.5rem;max-width:480px;width:100%;text-align:center}.logos{display:flex;align-items:center;justify-content:center;gap:1.5rem;margin-bottom:2rem}.logo-pyx{width:56px;height:56px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:14px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:20px}.logo-pi{width:56px;height:56px;background:#1e293b;border-radius:14px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:22px;font-family:monospace}.connector{color:#94a3b8;font-size:24px;font-weight:300}.check{width:64px;height:64px;border-radius:50%;background:#dcfce7;display:flex;align-items:center;justify-content:center;margin:0 auto 1rem}.check svg{width:32px;height:32px;stroke:#16a34a;fill:none;stroke-width:3;stroke-linecap:round;stroke-linejoin:round}h1{font-size:1.25rem;font-weight:700;margin-bottom:.5rem;color:#16a34a}p{color:#64748b;font-size:.875rem;line-height:1.5}.tag{display:inline-block;margin-top:1.5rem;padding:.35rem 1rem;background:#f1f5f9;border-radius:20px;font-size:.75rem;color:#64748b;font-weight:600}</style></head><body><div class="card"><div class="logos"><div class="logo-pyx">P</div><span class="connector">→</span><div class="logo-pi">π</div></div><div class="check"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div><h1>Authorization granted</h1><p>PyxCloud passobuild MCP is now connected to pi.<br>You can close this tab and return to your terminal.</p><div class="tag">staging</div></div></body></html>`);
        server.close(() => resolveCode(code));
      } else if (url.pathname === "/" || url.pathname === "") {
        // Waiting page — shown when user opens the URL before authorizing
        res.writeHead(200, { "Content-Type": "text/html; charset=utf-8" });
        res.end(`<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>PyxCloud · Connecting</title><style>*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,Ubuntu,Cantarell,sans-serif;background:#f8fafc;color:#1e293b;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:2rem}.card{background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,.08);padding:3rem 2.5rem;max-width:480px;width:100%;text-align:center}.logos{display:flex;align-items:center;justify-content:center;gap:1.5rem;margin-bottom:2rem}.logo-pyx{width:56px;height:56px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:14px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:20px}.logo-pi{width:56px;height:56px;background:#1e293b;border-radius:14px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:22px;font-family:monospace}.connector{color:#94a3b8;font-size:24px;font-weight:300}.spinner{width:48px;height:48px;border:4px solid #e2e8f0;border-top-color:#6366f1;border-radius:50%;animation:spin .8s linear infinite;margin:0 auto 1rem}@keyframes spin{to{transform:rotate(360deg)}}h1{font-size:1.25rem;font-weight:700;margin-bottom:.5rem}p{color:#64748b;font-size:.875rem;line-height:1.5}.tag{display:inline-block;margin-top:1.5rem;padding:.35rem 1rem;background:#f1f5f9;border-radius:20px;font-size:.75rem;color:#64748b;font-weight:600}</style></head><body><div class="card"><div class="logos"><div class="logo-pyx">P</div><span class="connector">→</span><div class="logo-pi">π</div></div><div class="spinner"></div><h1>Waiting for authorization</h1><p>Complete the login in the browser tab that opened.<br>This page will update automatically.</p><div class="tag">staging</div></div></body></html>`);
      } else {
        res.writeHead(404);
        res.end("Not found");
      }
